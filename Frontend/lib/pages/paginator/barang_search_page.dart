...
class BarangSearchPage extends StatefulWidget {
  const BarangSearchPage({required this.search});
  final String search;

  @override
  State<BarangSearchPage> createState() => _BarangSearchPageState();
}

class _BarangSearchPageState extends State<BarangSearchPage> {
  ...
  Future<void> fetchBarang(int? paginate) async {
    ...
    final response = await apiService.searchBarang(widget.search, paginate);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Search Paginator"),
        actions: [
